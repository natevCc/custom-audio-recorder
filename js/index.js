...
function stopAudioRecording() {
  ...
  console.log("AUDIO BLOB BEFORE STOP");
  console.log(JSON.stringify(audioRecorder.audioBlobs, null, 2));
  ...
  audioRecorder
    ...
    .then((audioAsblob) => {
      ...
      console.log("AUDIO BLOB AFTER STOP");
      console.log(JSON.stringify(audioAsblob, null, 2));
